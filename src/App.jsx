...
const WINDOWS = [
  ...
  },
  {
    ...
    content: <HelpWindowContent />, img: helpImg
...
{
  return (
    <GlassWidget style={{ cursor: 'pointer', display: 'flex', flexDirection: 'column', width: 104, alignItems: 'center', justifyContent: 'center', gap: 6 }}>  <span style={{ fontSize: 26 }}>😊</span>
...
export default function App()
{
  ...
  const [theme, setTheme] = useState('light')   // 'dark' | 'light' | 'wallpaper'
  ...
  return (
    ...
    >
      ...
      <div className="w-14 h-14 rounded-[14px] flex items-center justify-center text-3xl
        ...
        {win.img
          ? <img src={win.img} alt={win.label} className="w-full h-full object-cover" />
          : win.icon}
      </div>
