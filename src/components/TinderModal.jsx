...
export default function TinderModal({ onClose }) {
  ...
  const triggerSwipe = (dir) => {
    ...
    setTimeout(() => {
      setSwiping(null)
      if (cardIdx < SWIPES.length - 1) setCardIdx(i => i + 1)
      else setCardIdx(0)
    }, 500)
  }
      ...
      >
        ...
        <div style={{ padding: '24px 28px', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: 18, fontWeight: 700, marginBottom: 8, lineHeight: 1.3 }}>
            Sorry, Yingli is only interested in <span style={{ color: '#febc2e' }}>money</span>,
            <br />not homo sapiens.
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              transform: swiping === 'left'
                ? 'rotate(-25deg) translateX(-180px) opacity(0)'
                : swiping === 'right'
